...
if (!event) return '';
  return (
    <div className="flex flex-col mx-5 xl:mx-32 md:mx-10 mt-5 flex-grow">
     <div >
        {event.image &&(
          <img src={`https://evento-ems-api.onrender.com/${event.image}`} alt="" height="500px" width="1440px" className='rounded object-fill aspect-16:9'/>
        )}
      </div>
      ...
      <div className="mx-2">
          <h2 className="text-md md:text-xl font-bold mt-3 text-primarydark">{event.ticketPrice === 0? 'Free' : 'KSH. '+ event.ticketPrice}</h2>
      </div>
